...
#SBATCH --job-name="Pn23bb_Rha_6RU_Run2"
#SBATCH --dependency=afterok:
#SBATCH --mail-user=YRLNIC001@myuct.ac.za
#SBATCH --mail-type=ALL


cd /scratch/yrlnic001/Pn23bb_Rha_6RU/Run2
...
/opt/exp_soft/NAMD_2.14_Linux-x86_64-multicore-CUDA/namd2 +p32 +idlepoll +noAnytimeMigration +setcpuaffinity +isomalloc_sync run_2.conf > run_2.log
